  ...
  return (
    <div className="space-y-8">
      ...
      <div className="card bg-gradient-to-br from-green-50 to-green-100">
        <h3 className="text-lg font-semibold mb-2 text-green-800">Total Personal Expenses</h3>
        <div className="flex items-center justify-between">
          <p className="text-3xl font-bold text-green-600">${totalPersonalExpense.toFixed(2)}</p>
          <span className="text-sm text-green-600">{currentMonth} {currentYear}</span>
        </div>
      </div>
